...
class CamionArrendadoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CamionArrendado']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('CamionArrendado');
	...
	{
		$model=new CamionArrendado('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CamionArrendado']))
			$model->attributes=$_GET['CamionArrendado'];
	...
	{
		$model=CamionArrendado::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='camion-arrendado-form')
		{
