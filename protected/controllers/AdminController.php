        ...
        public function actionDicc(){
            ...
            foreach($camionesArrendados as $camionArrendado){
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('B'.$i, (double)Tools::cleanExport($camionArrendado->capacidad,'number'))
                            ->setCellValue('C'.$i, (double)Tools::cleanExport($camionArrendado->consumoPromedio,'number'))
                            ->setCellValue('D'.$i, (double)Tools::cleanExport($camionArrendado->coeficienteDeTrato,'number'))
                            ->setCellValue('E'.$i, (double)Tools::cleanExport($camionArrendado->produccionMinima,'number'))
                            ->setCellValue('F'.$i, (double)Tools::cleanExport($camionArrendado->horasMin,'number'))
            ...
            foreach($camionesPropios as $camionPropio){
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('C'.$i, (double)Tools::cleanExport($camionPropio->capacidad,'number'))
                            ->setCellValue('D'.$i, (double)Tools::cleanExport($camionPropio->consumoPromedio,'number'))
                            ->setCellValue('E'.$i, (double)Tools::cleanExport($camionPropio->coeficienteDeTrato,'number'))
                            ->setCellValue('F'.$i, (double)Tools::cleanExport($camionPropio->produccionMinima,'number'))
                            ->setCellValue('G'.$i, (double)Tools::cleanExport($camionPropio->horasMin,'number'))
