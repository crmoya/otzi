...
class EquipoPropioController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('EquipoPropio');
	...
	{
		$model=new EquipoPropio('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EquipoPropio']))
			$model->attributes=$_GET['EquipoPropio'];
	...
	{
		$model=EquipoPropio::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='equipo-propio-form')
		{
