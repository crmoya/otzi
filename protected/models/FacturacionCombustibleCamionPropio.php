...
/**
 * This is the model class for table "facturacionCombustibleCamionPropio".
 *
 * The followings are the available columns in table 'facturacionCombustibleCamionPropio':
 * @property integer $id
 ...
 */
class FacturacionCombustibleCamionPropio extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return FacturacionCombustibleCamionPropio the static model class
	 */
	...
	{
		return 'facturacionCombustibleCamionPropio';
	}
