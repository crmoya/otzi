...
/**
 * This is the model class for table "mod_ca_autorizada_por".
 *
 * The followings are the available columns in table 'mod_ca_autorizada_por':
 * @property integer $id
 ...
 */
class ModCaAutorizadaPor extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('usuario_1, usuario_2, fecha, rCamionArrendado_id', 'required'),
			array('usuario_1, usuario_2, rCamionArrendado_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, usuario_1, usuario_2, fecha, rCamionArrendado_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ModCaAutorizadaPor the static model class
	 */
