...
/**
 * This is the model class for table "remuneracionEquipoArrendado".
 *
 * The followings are the available columns in table 'remuneracionEquipoArrendado':
 * @property integer $id
 ...
 */
class RemuneracionEquipoArrendado extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return RemuneracionEquipoArrendado the static model class
	 */
	...
	{
		return 'remuneracionEquipoArrendado';
	}
