...
/**
 * This is the model class for table "compraRepuestoCamionArrendado".
 *
 * The followings are the available columns in table 'compraRepuestoCamionArrendado':
 * @property integer $id
 ...
 */
class CompraRepuestoCamionArrendado extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CompraRepuestoCamionArrendado the static model class
	 */
	...
	{
		return 'compraRepuestoCamionArrendado';
	}
	...
	public function rules()
	{
		...
		return array(
			array('repuesto, montoNeto, rCamionArrendado_id', 'required'),
			array('montoNeto, cantidad, rCamionArrendado_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, repuesto, montoNeto, guia, factura, cantidad, unidad, rCamionArrendado_id', 'safe', 'on'=>'search'),
		);
	}
