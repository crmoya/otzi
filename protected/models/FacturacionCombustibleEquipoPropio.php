...
/**
 * This is the model class for table "facturacionCombustibleEquipoPropio".
 *
 * The followings are the available columns in table 'facturacionCombustibleEquipoPropio':
 * @property integer $id
 ...
 */
class FacturacionCombustibleEquipoPropio extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return FacturacionCombustibleEquipoPropio the static model class
	 */
	...
	{
		return 'facturacionCombustibleEquipoPropio';
	}
