...
/**
 * This is the model class for table "cargaCombEquipoArrendado".
 *
 * The followings are the available columns in table 'cargaCombEquipoArrendado':
 * @property integer $id
 ...
 */
class CargaCombEquipoArrendado extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CargaCombEquipoArrendado the static model class
	 */
	...
	{
		return 'cargaCombEquipoArrendado';
	}
	...
	public function rules()
	{
		...
		return array(
			array('petroleoLts, precioUnitario, valorTotal, faena_id, tipoCombustible_id, supervisorCombustible_id, rEquipoArrendado_id', 'required'),
			array('precioUnitario, faena_id, tipoCombustible_id, supervisorCombustible_id, rEquipoArrendado_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, petroleoLts, hCarguio, guia, factura, precioUnitario, valorTotal, faena_id, tipoCombustible_id, supervisorCombustible_id, rEquipoArrendado_id', 'safe', 'on'=>'search'),
		);
	}
