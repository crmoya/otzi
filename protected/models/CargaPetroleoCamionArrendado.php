...
/**
 * This is the model class for table "cargaPetroleoCamionArrendado".
 *
 * The followings are the available columns in table 'cargaPetroleoCamionArrendado':
 * @property integer $id
 * @property string $petroleoLts
 * @property string $kmCarguio
 * @property integer $reg_id
 */
class CargaPetroleoCamionArrendado extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return CargaPetroleoCamionArrendado the static model class
	 */
	...
	{
		return 'cargaPetroleoCamionArrendado';
	}
