...
class REquipoArrendado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('fecha, reporte, ordenCompra, horas, faena_id, equipoArrendado_id, operador_id', 'required'),
			array('faena_id, equipoArrendado_id, operador_id', 'numerical', 'integerOnly'=>true),
