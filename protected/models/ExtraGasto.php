 ...
 *
 * The followings are the available columns in table 'extra_gasto':
 * @property integer $id
 ...
 */
class ExtraGasto extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, value, code', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, value, code, gasto_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ExtraGasto the static model class
	 */
