...
/**
 * This is the model class for table "facturacionCombustibleCamionArrendado".
 *
 * The followings are the available columns in table 'facturacionCombustibleCamionArrendado':
 * @property integer $id
 ...
 */
class FacturacionCombustibleCamionArrendado extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return FacturacionCombustibleCamionArrendado the static model class
	 */
	...
	{
		return 'facturacionCombustibleCamionArrendado';
	}
