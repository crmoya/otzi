...
/**
 * This is the model class for table "ep_anticipo".
 *
 * The followings are the available columns in table 'ep_anticipo':
 * @property integer $id
 ...
 */
class EpAnticipo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return EpAnticipo the static model class
	 */
