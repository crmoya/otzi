...
/**
 * This is the model class for table "expedicionequipopropio".
 *
 * The followings are the available columns in table 'expedicionequipopropio':
 * @property integer $id
 ...
 */
class Expedicionequipopropio extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('cantidad, total, faena_id, unidadfaena_equipo_id, requipopropio_id', 'required'),
			array('faena_id, unidadfaena_equipo_id, requipopropio_id', 'numerical', 'integerOnly'=>true),
			array('cantidad, total', 'length', 'max'=>12),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, cantidad, total, faena_id, unidadfaena_equipo_id, requipopropio_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Expedicionequipopropio the static model class
	 */
