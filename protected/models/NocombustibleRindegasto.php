...
/**
 * This is the model class for table "nocombustible_rindegasto".
 *
 * The followings are the available columns in table 'nocombustible_rindegasto':
 * @property integer $id
 ...
 */
class NocombustibleRindegasto extends CActiveRecord
{
	/**
	...
	{
		return 'nocombustible_rindegasto';
	}
	...
	public function rules()
	{
		...
		return array(
			array('fecha, total, gasto_completa_id', 'required'),
			...
			array('id, camionpropio_id, camionarrendado_id, equipoarrendado_id, equipopropio_id, fecha, total, gasto_completa_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return NocombustibleRindegasto the static model class
	 */
