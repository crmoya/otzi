...
class ConsumoCamiones extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$inicioAgrupacion = "	maquina,
								...
								sum(kms) as kms,
								sum(kms_gps) as kms_gps,
								avg(consumo_esperado) as consumo_esperado,
								sum(kms)/sum(litros) as kms_litro,
								sum(kms_gps)/sum(litros) as kms_litro_gps    ";
