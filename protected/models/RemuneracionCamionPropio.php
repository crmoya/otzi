...
/**
 * This is the model class for table "remuneracionCamionPropio".
 *
 * The followings are the available columns in table 'remuneracionCamionPropio':
 * @property integer $id
 ...
 */
class RemuneracionCamionPropio extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return RemuneracionCamionPropio the static model class
	 */
	...
	{
		return 'remuneracionCamionPropio';
	}
	...
	public function rules()
	{
		...
		return array(
			array('descripcion, montoNeto, rCamionPropio_id', 'required'),
			...
			array('id, descripcion, montoNeto, guia, documento, cantidad, unidad, rCamionPropio_id', 'safe', 'on'=>'search'),
		);
	}
