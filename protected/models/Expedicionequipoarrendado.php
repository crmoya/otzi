...
/**
 * This is the model class for table "expedicionequipoarrendado".
 *
 * The followings are the available columns in table 'expedicionequipoarrendado':
 * @property integer $id
 ...
 */
class Expedicionequipoarrendado extends CActiveRecord
{
	/**
	...
	{
		return 'expedicionequipoarrendado';
	}
	...
	public function rules()
	{
		...
		return array(
			array('cantidad, total, faena_id, unidadfaena_equipo_id, requipoarrendado_id', 'required'),
			array('faena_id, unidadfaena_equipo_id, requipoarrendado_id', 'numerical', 'integerOnly'=>true),
			array('cantidad, total', 'length', 'max'=>12),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, cantidad, total, faena_id, unidadfaena_equipo_id, requipoarrendado_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Expedicionequipoarrendado the static model class
	 */
