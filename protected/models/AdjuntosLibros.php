...
/**
 * This is the model class for table "adjuntos_libros".
 *
 * The followings are the available columns in table 'adjuntos_libros':
 * @property integer $id
 ...
 */
class AdjuntosLibros extends CActiveRecord
{
	 ...
	 * @return AdjuntosLibros the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('nombre_archivo, fecha, contratos_id, subidor_id', 'required'),
			...
			array('id, nombre_archivo, fecha, contratos_id, subidor_id', 'safe', 'on'=>'search'),
		);
	}
