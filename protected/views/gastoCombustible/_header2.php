...
$this->breadcrumbs=array(
	'Infome de Gasto de Combustibles'=>array('admin'),
	'Detalle de informe de gastos de combustibles',
);
...
<p>
    <table>
        ...
        ?>
        <?php
        if($tipoCombustible_id != ""){
            echo "<tr>";
            echo "<td width='150px'><b>Tipo Combustible</b>: </td><td>";
            $tipoCombustible = TipoCombustible::model()->findByPk($tipoCombustible_id);
            echo (isset($tipoCombustible))?$tipoCombustible->nombre:''."</td></tr>";
        }
        ?>
        <?php
        if($maquina != ""){
