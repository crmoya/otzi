...
<h3>Digitalizaciones de Resoluciones de contrato <?php echo CHtml::encode($contrato->nombre);?></h3>
...
<div class="form" style="width:900px;">
	...
	<fieldset>
		...
		<?php 
		$iterator=0;
		foreach($resoluciones as $i=>$iter):?>
				...
				<td>
					<table cellpadding="0" cellspacing="0" style="font-size:0.8em;">
						...
						<tr>
							...
							<td>
									<b>Monto:</b>
									<span class="plata"><?php echo CHtml::encode($iter->monto);?></span>
							</td>
							<td>
									<b>Plazo:</b>
									<?php echo CHtml::encode($iter->plazo); ?>
							</td>
							<td>
									<b>Fecha Resolución:</b>
									<?php echo CHtml::encode(Tools::backFecha($iter->fecha_resolucion)); ?>
							</td>
							<td>
									<b>Fecha Inicio:</b>
									<?php echo CHtml::encode(Tools::backFecha($iter->fecha_inicio)); ?>
							</td>
							<td>
									<b>Fecha Fin:</b>
									<?php echo CHtml::encode(Tools::backFecha($iter->fecha_final)); ?>
							</td>
						</tr>
						<tr>
							<td colspan="6">
					...
					<fieldset>
						<legend>Digitalizaciones de la Resolución:</legend>
						...
						<div>Nueva Digitalización
							...
							echo $form->hiddenField($archivo,'resoluciones_id',array('value'=>$iter->id));
						...
						?>
							<tr>
								...
								<td><?php echo CHtml::link("descargar",CController::createUrl('//site/download',array('path'=>$iter->id.$adjunto->nombre_archivo,'nombre'=>$adjunto->nombre_archivo,'tipo'=>'resolucion')));?></td>
							</tr>
						<?php 
							$i++;
							endforeach;
