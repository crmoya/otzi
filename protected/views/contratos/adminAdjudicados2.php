...
<h1>Ingresar Flujos de Producción real para un contrato</h1>
	...
	'columns'=>array(
		...
		array(
		    ...
		    (
		        'editar' => array
		        (
		            'label'=>'Agregar Flujos Reales',
		            'imageUrl'=>Yii::app()->request->baseUrl.'/images/edit.png',
		            'url'=>'Yii::app()->createUrl("contratos/flujosReales", array("id"=>$data->contratos_id))',
		        ),
		    ),
		),
	),
