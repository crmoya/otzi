...
<table>
    <tr>
        <td><h1>Modificar Flujos de Producción programada para un contrato</h1></td>
        <td><a href='<?=CController::createUrl('//contratos/exportarConAdj'); ?>'>Exportar a Excel</a></td>
    </tr>
</table>
	...
	'columns'=>array(
		...
		array(
		    ...
		    (
		        'editar' => array
		        (
		            'label'=>'Modificar Flujos Programados',
		            'imageUrl'=>Yii::app()->request->baseUrl.'/images/edit.png',
		            'url'=>'Yii::app()->createUrl("contratos/flujosProgramados", array("id"=>$data->contratos_id))',
		        ),
		    ),
		),
	),
