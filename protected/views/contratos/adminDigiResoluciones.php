...
<h1>Eliminar una digitalización de resoluciones para el contrato <?php echo CHtml::encode($nombre_contrato);?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'destino-grid',
	'dataProvider'=>$model->searchResolucion($id),
	'afterAjaxUpdate' => 'reinstallDatePicker',
	'ajaxUpdate'=>false,
	'filter'=>$model,
	'columns'=>array(
		array('name'=>'resoluciones', 'value'=>'$data->resoluciones->numero'),
		'nombre_archivo',
		array(            
            'name'=>'fecha',
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("contratos/eliminarDigiResoluciones", array("id"=>$data->id,"contrato"=>'.$id.'))',
		        ),
		    ),
		),
	),
