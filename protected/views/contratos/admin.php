...
<table>
    <tr>
        <td><h1>Adjudicar un Contrato</h1></td>
        <td><a href='<?=CController::createUrl('//contratos/exportarCon'); ?>'>Exportar a Excel</a></td>
    </tr>
</table>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'destino-grid',
	'dataProvider'=>$model->searchNuevosUsuarioActual(),
	...
	'columns'=>array(
		...
		array(            
                    'name'=>'fecha_inicio',
                    'header'=>'Fecha de Oferta Técnica o Cotización',
		...
		array(
		    ...
		    (
		        'adjudicar' => array
		        (
		            'label'=>'Adjudicar este contrato',
		            'imageUrl'=>Yii::app()->request->baseUrl.'/images/ok.png',
		            'url'=>'Yii::app()->createUrl("contratos/adjudicar", array("id"=>$data->contratos_id))',
		        ),
		    ),
		),
	),
