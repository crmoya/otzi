...
<h3>Digitalizaciones de Contrato <?php echo CHtml::encode($contrato->nombre);?></h3>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<fieldset>
		<legend>Digitalizaciones del Contrato:</legend>
		<div>Nueva Digitalización
			<?php echo $form->fileField($archivo, 'file');?>
			<?php echo CHtml::submitButton('Guardar'); ?>
		</div>
		<table class="digitalizaciones">
		<?php 
			$adjuntos = $contrato->getAdjuntos();
			$i=1;
		...
		?>
			<tr>
				...
				<td><?php echo CHtml::link("descargar",CController::createUrl('//site/download',array('path'=>$contrato->id.$adjunto->nombre_archivo,'nombre'=>$adjunto->nombre_archivo,'tipo'=>'contrato')));?></td>
			</tr>
		<?php 
			$i++;
			endforeach;
