...
<h1>Eliminar digitalización de libros de obra y comunicaciones <?php echo CHtml::encode($nombre_contrato);?></h1>
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("contratos/eliminarDigiLibros", array("id"=>$data->id))',
		        ),
		    ),
		),
	),
