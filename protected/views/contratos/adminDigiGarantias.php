...
<h1>Eliminar una digitalización para las garantías del contrato <?php echo CHtml::encode($nombre_contrato);?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'destino-grid',
	'dataProvider'=>$model->searchGarantia($id),
	'afterAjaxUpdate' => 'reinstallDatePicker',
	'ajaxUpdate'=>false,
	'filter'=>$model,
	'columns'=>array(
		array('name'=>'garantias', 'value'=>'$data->garantias->numero'),
		'nombre_archivo',
		array(            
            'name'=>'fecha',
		...
		array(
		    ...
		    (
		        ...
		        (
		            ...
		            'url'=>'Yii::app()->createUrl("contratos/eliminarDigiGarantias", array("id"=>$data->id,"contrato"=>'.$id.'))',
		        ),
		    ),
		),
	),
