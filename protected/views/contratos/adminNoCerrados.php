	...
	'columns'=>array(
		...
		array(
		    ...
		    (
		        'cerrar' => array
		        (
		            'label'=>'Cerrar este Contrato',
		            'imageUrl'=>Yii::app()->request->baseUrl.'/images/cerrar.png',
		            'url'=>'Yii::app()->createUrl("contratos/cerrar", array("id"=>$data->contratos_id))',
		        ),
		    ),
		),
	),
