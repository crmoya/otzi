...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'rol', CHtml::listData(array(array('id'=>'administrador','nombre'=>'Administrador'),array('id'=>'operativo','nombre'=>'Operativo'),array('id'=>'gerencia','nombre'=>'Gerencia')), 'id', 'nombre')); ?>
