	...
	$(function() {
		...
		$('#habilitar').click(function(e) {
			$.ajax({
				...
				data: {
					admin1: $('#REquipoArrendado_administrador_1').val(),
					admin2: $('#REquipoArrendado_administrador_2').val(),
					aut1: $('#REquipoArrendado_clave_admin_1').val(),
					aut2: $('#REquipoArrendado_clave_admin_2').val(),
												...
												<td width="100px">
													<table style="border:solid 1px silver;padding:10px;">
														...
														<tr>
															...
															<td><?php echo $form->textField($combustible, "[$i]numero", array('i' => $i, 'class' => 'nroRendicion', 'id' => "numero$i", 'disabled' => $model->validado == 1 ? 'disabled' : '',)); ?><div id="errorNumero<?php echo $i; ?>" class="errorMessage errorNumero"></div>
															</td>
															<td></td>
														...
														<tr>
															...
															<td><?php echo $form->textField($combustible, "[" . $i . "]observaciones", array('id' => "observaciones$i", 'disabled' => $model->validado == 1 ? 'disabled' : '')); ?><div id="errorObservaciones<?php echo $i; ?>" style="color:red;width:100px;"></div>
															</td>
															<td></td>

															<td><?php echo $form->labelEx($combustible, "guia", array('style' => 'width:80px;')); ?></td>
															<td><?php echo $form->textField($combustible, "[$i]guia", array('id' => "guia$i", 'disabled' => $model->validado == 1 ? 'disabled' : '')); ?><div id="errorGuia<?php echo $i; ?>" style="color:red;width:100px;"></div>
															</td>
															<td></td>
															<td></td>
														</tr>
												...
												<td width="100px">
													<table style="border:solid 1px silver;padding:10px;">
														...
														<tr>
															...
															<td><?php echo $form->dropDownList($repuesto, '[' . $i . ']faena_id', CHtml::listData(Faena::model()->listar($repuesto->faena_id), 'id', 'nombre'), array('id' => 'faenaR_id' . $i, 'disabled' => $model->validado == 1 ? 'disabled' : '')); ?></td>
															<td>
														...
														<tr>
															...
															<td><?php echo $form->textField($repuesto, "[$i]cantidad", array('id' => "cantidadR$i", 'disabled' => $model->validado == 1 ? 'disabled' : '','class'=>'fixed')); ?><div id="errorCantidadR<?php echo $i; ?>" style="color:red;width:100px;"></div>
															</td>
															<td></td>
														...
														<tr>
															...
															<td><?php echo $form->textField($repuesto, "[$i]numero", array('id' => "numeroRep$i", 'disabled' => $model->validado == 1 ? 'disabled' : '',)); ?><div id="errorNumeroRep<?php echo $i; ?>" style="color:red;width:100px;"></div>
															</td>
															<td></td>
