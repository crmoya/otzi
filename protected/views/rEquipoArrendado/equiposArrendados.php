	...
	$(function() {
		...
		$(document.body).on('keyup','.rut_proveedor',function(e){
                ...
                $('#habilitar').click(function(e){
                    $.ajax({
			  type: "POST",
			  url: "<?php echo Yii::app()->createUrl('//rEquipoArrendado/unlock/');?>",
			  data: { admin1:  $('#REquipoArrendado_administrador_1').val(), admin2:$('#REquipoArrendado_administrador_2').val(), aut1: $('#REquipoArrendado_clave_admin_1').val(), aut2: $('#REquipoArrendado_clave_admin_2').val(),report_id:<?php echo $model->id;?>}
			}).done(function( msg ) {
                            if(msg != 'OK'){
                                alert(msg);
                            }
                            else
                            {
                                ...
                                window.location = "<?php echo CController::createUrl('//rEquipoArrendado/update/'.$model->id);?>";
...
?>
	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td><?php echo $form->textField($model,'ordenCompra',array('disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?><?php echo $form->error($model,'ordenCompra'); ?></td>
				<td style='font-size: 0.9em;'><b>Propietario:</b></td>
				<td id="equipo"><?php echo $codigo;?></td>
			</tr>
		</table>
	</fieldset>
	<fieldset>
		...
		<table>
			<tr> 
			  <td width="30"><?php echo $form->labelEx($model,'reporte'); ?></td><td><?php echo $form->textField($model,'reporte',array('disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?><?php echo $form->error($model,'reporte'); ?></td>
			 ...
			 <tr>
			  <td width="30"><?php echo $form->labelEx($model,'hInicial'); ?></td><td><?php echo $form->textField($model,'hInicial',array('id'=>"hInicial",'class'=>'fixedHInicial','disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?><?php echo $form->error($model,'hInicial'); ?></td>
			  <td width="30"><?php echo $form->labelEx($model,'hFinal'); ?></td><td><?php echo $form->textField($model,'hFinal',array('id'=>"hFinal",'class'=>'fixedHFinal','disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?><?php echo $form->error($model,'hFinal'); ?></td>
		 	...
		 	<tr>
		 	  <td width="30"><?php echo $form->labelEx($model,'horasGps'); ?></td><td><?php echo $form->textField($model,'horasGps',array('class'=>'fixed','disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?><?php echo $form->error($model,'horas'); ?></td>
			  <td width="30"><?php echo $form->labelEx($model,'faena_id'); ?></td>
			  <td colspan="3">
			   <?php echo $form->dropDownList($model,'faena_id', CHtml::listData(Faena::model()->listar(), 'id', 'nombre'),array('disabled'=>$model->validado==1 || $model->validado==2?'disabled':'',)); ?>
											...
											<td width="100px">
												<table style="border:solid 1px silver;padding:10px;">
													<tr>
														...
														<td><?php echo $form->dropDownList($expedicion, "[$i]faena_id", CHtml::listData(Faena::model()->listarPorTiempoE(), 'id', 'nombre'), array('id' => "faenaT_id$i", 'class' => 'faenaT', 'selUnidad'=> $expedicion->unidadfaenaEquipo->id, 'disabled' => $model->validado == 1 || $model->validado == 2 ? 'disabled' : '',)); ?></td>
														<td>
										...
										<td width="100px">
											<table style="border:solid 1px silver;padding:10px;">
												<tr>
												  	...
												  	<input type="hidden" class="rowIndex" value="<?php echo $i;?>" />
												   	...
												   	<div class="remove" tipo="combustible" id="removeCombustible<?php echo $i;?>" validate="true">Eliminar</div>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->dropDownList($combustible,'['.$i.']tipo_documento',CHtml::listData(Tools::listarTiposDocumentosComb() ,'id', 'nombre'),array('disabled'=>$model->validado==1?'disabled':'',));?></td>
                                                                                                 <td></td>
												 <td><?php echo $form->labelEx($combustible,"factura",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->textField($combustible,"[$i]factura",array('id'=>"factura$i",'class'=>"factura",'i'=>$i,'disabled'=>$model->validado==1?'disabled':'',));?></td>
												 ...
												 <td></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($combustible,"[".$i."]rut_proveedor",array('id'=>"rut_proveedor".$i,'class'=>'rut_proveedor','i'=>$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($combustible,"[".$i."]nombre_proveedor",array('id'=>"nombre_proveedor".$i,'class'=>'nombre_proveedor','i'=>$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]petroleoLts",array('id'=>"petroleoLts$i",'class'=>'fixedPetroleoLts','disabled'=>$model->validado==1?'disabled':'',));?></td>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]hCarguio",array('id'=>"kmCarguio$i",'class'=>'fixed','disabled'=>$model->validado==1?'disabled':'',));?></td>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]precioUnitario",array('id'=>"precioUnitario$i",'class'=>'fixedPrecio','disabled'=>$model->validado==1?'disabled':'',));?></td>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]valorTotal",array('id'=>"valorTotal$i",'class'=>'fixedValor','disabled'=>$model->validado==1?'disabled':'',));?></td>
												...
												<tr>
												  ...
												  <td><?php echo $form->dropDownList($combustible,"[$i]tipoCombustible_id",CHtml::listData(TipoCombustible::model()->listar(), 'id', 'nombre'),array('id'=>"tipoCombustible$i",'disabled'=>$model->validado==1?'disabled':'',));?></td>
												  ...
												  <td><?php echo $form->dropDownList($combustible,"[$i]supervisorCombustible_id",CHtml::listData(SupervisorCombustible::model()->listar(), 'id', 'nombre'),array('id'=>"supervisor$i",'disabled'=>$model->validado==1?'disabled':'',));?></td>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]numero",array('i'=>$i,'class'=>'nroRendicion','id'=>"numero$i",'disabled'=>$model->validado==1?'disabled':'',));?><div id="errorNumero<?php echo $i;?>" class="errorMessage errorNumero"></div></td>
												 <td></td>
												 
												 <td><?php echo $form->labelEx($combustible,"rut_rinde",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->textField($combustible,"[$i]rut_rinde",array('class'=>'rut_rinde','id'=>"rut_rinde$i",'i'=>$i,'disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
												 <td></td>
												</tr>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($combustible,"[$i]fechaRendicion",array('id'=>"fechaRendicion$i",'class'=>'fecha','readonly'=>'readonly','disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
												 
												 <td><?php echo $form->labelEx($combustible,"nombre",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->textField($combustible,"[$i]nombre",array('id'=>"nombre$i",'class'=>'nombre_rinde','i'=>$i,'disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
												 <td></td>
												</tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($combustible,"[".$i."]observaciones",array('id'=>"observaciones$i",'disabled'=>$model->validado==1?'disabled':''));?><div id="errorObservaciones<?php echo $i;?>" style="color:red;width:100px;"></div></td>
                                                                                                 <td></td>

                                                                                                 <td><?php echo $form->labelEx($combustible,"guia",array('style'=>'width:80px;'));?></td>
                                                                                                 <td><?php echo $form->textField($combustible,"[$i]guia",array('id'=>"guia$i",'disabled'=>$model->validado==1?'disabled':''));?><div id="errorGuia<?php echo $i;?>" style="color:red;width:100px;"></div></td>
                                                                                                 <td></td>
                                                                                                 <td></td>
                                                                                                </tr>
										...
										<td width="100px">
											<table style="border:solid 1px silver;padding:10px;">
												<tr>
												  ...
												  <td><?php echo $form->textField($repuesto,"[$i]repuesto",array('id'=>"repuesto$i",'class'=>'repuesto','disabled'=>$model->validado==1?'disabled':'',));?></td>
												  ...
												  <td><?php echo $form->textField($repuesto,"[$i]montoNeto",array('id'=>"montoNeto$i",'class'=>'fixedInt','disabled'=>$model->validado==1?'disabled':'',));?></td>
												...
												<tr>
												 <td><?php echo $form->labelEx($repuesto,"tipo_documento",array('style'=>'width:80px;'));?></td>
                                                                                                 <td><?php echo $form->dropDownList($repuesto,'['.$i.']tipo_documento',CHtml::listData(Tools::listarTiposDocumentos() ,'id', 'nombre'),array('id'=>"tipoDocumento$i",'disabled'=>$model->validado==1?'disabled':'',));?></td>
                                                                                                 <td></td>
												 
												 <td><?php echo $form->labelEx($repuesto,"factura",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->textField($repuesto,"[$i]factura",array('id'=>"factura$i",'disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
												 <td></td>
												</tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($repuesto,"[$i]rut_proveedor",array('id'=>"rut_proveedorR$i",'class'=>'rut_proveedorR','i'=>$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($repuesto,"[$i]nombre_proveedor",array('id'=>"nombre_proveedorR$i",'class'=>'nombre_proveedorR','i'=>$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->dropDownList($repuesto,'['.$i.']cuenta',CHtml::listData(CuentaContableRepuesto::model()->findAll(), 'nombre', 'nombre'),array('id'=>'cuentaR'.$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                 ...
                                                                                                 <td><?php echo $form->dropDownList($repuesto,'['.$i.']faena_id',CHtml::listData(Faena::model()->listar(), 'id', 'nombre'),array('id'=>'faenaR_id'.$i,'disabled'=>$model->validado==1?'disabled':''));?></td>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($repuesto,"[$i]cantidad",array('id'=>"cantidad$i",'disabled'=>$model->validado==1?'disabled':'',));?><div id="errorCantidad<?php echo $i;?>" style="color:red;width:100px;"></div></td>
												 <td></td>
												 <td><?php echo $form->labelEx($repuesto,"unidad",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->dropDownList($repuesto,"[$i]unidad",CHtml::listData(Unidad::model()->findAll(), 'sigla', 'nombre'),array('id'=>"unidad$i",'disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
												 <td></td>
												</tr>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($repuesto,"[$i]numero",array('id'=>"numeroRep$i",'disabled'=>$model->validado==1?'disabled':'',));?><div id="errorNumeroRep<?php echo $i;?>" style="color:red;width:100px;"></div></td>
												 <td></td>
												 
												 <td><?php echo $form->labelEx($repuesto,"rut_rinde");?></td>
												 <td><?php echo $form->textField($repuesto,"[$i]rut_rinde",array('style'=>'width:80px;','class'=>'rut_rindeR','id'=>"rut_rindeR$i",'i'=>$i,'disabled'=>$model->validado==1?'disabled':'',));?> </td>
												 <td></td>
												 <td></td>
												</tr>
												...
												<tr>
												 ...
												 <td><?php echo $form->textField($repuesto,"[$i]nombre",array('class'=>'nombre_rindeR','id'=>"nombreR$i",'i'=>$i,'disabled'=>$model->validado==1?'disabled':'',));?> </td>
												 <td></td>
												 <td><?php echo $form->labelEx($repuesto,"fechaRendicion",array('style'=>'width:80px;'));?></td>
												 <td><?php echo $form->textField($repuesto,"[$i]fechaRendicion",array('id'=>"fechaRendicionRep$i",'class'=>'fecha','readonly'=>'readonly','disabled'=>$model->validado==1?'disabled':'',));?></td>
												 <td></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                 ...
                                                                                                 <td><?php echo $form->textField($repuesto,"[$i]guia",array('id'=>"guia$i",'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                 <td></td>

                                                                                                 <td><?php echo $form->labelEx($repuesto,"observaciones",array('style'=>'width:80px;'));?></td>
                                                                                                 <td><?php echo $form->textField($repuesto,"[$i]observaciones",array('id'=>"observaciones$i",'disabled'=>$model->validado==1?'disabled':''));?></td>
                                                                                                 <td></td>
                                                                                                 <td></td>
                                                                                                </tr>
	...
	<fieldset>
		...
		<table>
			<tr>
				<td style='width:150px;'>¿Ingresar Panne?</td><td><?php echo $form->checkbox($model,'panne',array('id'=>'checkPanne','disabled'=>$model->validado==1?'disabled':''));?></td>
			</tr>
			<tr>
				<td colspan='2'>
					<div id='panne'>
		...
		<div class="table table-hover">
			...
			foreach($archivos as $a => $archivo):?>	
				<div class="archivo">
					...
					<a target="_blank" href="<?=CController::createUrl("//admin/download",['file'=>$archivo,'id'=>$model->id,'tipo'=>'equipos_arrendados']);?>"><?=$archivo?></a>
				</div>
			<?php endforeach;?>
		</div>
		<br/>
