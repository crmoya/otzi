												...
												<td width="100px">
													<table style="border:solid 1px silver;padding:10px;">
														...
														<tr>
															...
															<td><?php echo $form->dropDownList($combustible, '[' . $i . ']tipo_documento', CHtml::listData(Tools::listarTiposDocumentos(), 'id', 'nombre'), array('disabled' => $model->validado == 1 ? 'disabled' : '',)); ?></td>
															<td></td>
