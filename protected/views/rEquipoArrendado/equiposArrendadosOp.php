...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<fieldset>
		...
		<table>
			<tr> 
			  <td width="30"><?php echo $form->labelEx($model,'reporte'); ?></td><td><?php echo $form->textField($model,'reporte',array('disabled'=>$model->validado==1?'disabled':'',)); ?><?php echo $form->error($model,'reporte'); ?></td>
			 ...
			 <tr>
			  <td width="30"><?php echo $form->labelEx($model,'hInicial'); ?></td><td><?php echo $form->textField($model,'hInicial',array('id'=>"hInicial",'class'=>'fixedHInicial','disabled'=>$model->validado==1?'disabled':'',)); ?><?php echo $form->error($model,'hInicial'); ?></td>
			  <td width="30"><?php echo $form->labelEx($model,'hFinal'); ?></td><td><?php echo $form->textField($model,'hFinal',array('id'=>"hFinal",'class'=>'fixedHFinal','disabled'=>$model->validado==1?'disabled':'',)); ?><?php echo $form->error($model,'hFinal'); ?></td>
		 	...
		 	<tr>
		 	  <td width="30"><?php echo $form->labelEx($model,'horasGps'); ?></td><td><?php echo $form->textField($model,'horasGps',array('class'=>'fixed','disabled'=>$model->validado==1?'disabled':'',)); ?><?php echo $form->error($model,'horas'); ?></td>
			  <td width="30"><?php echo $form->labelEx($model,'faena_id'); ?></td>
			  <td colspan="3">
			   <?php echo $form->dropDownList($model,'faena_id', CHtml::listData(Faena::model()->listar(), 'id', 'nombre'),array('disabled'=>$model->validado==1?'disabled':'',)); ?>
										...
										<td width="100px">
											...
											<table style="border:solid 1px silver;padding:10px;">
                                                                                          ...
                                                                                          <tr>
                                                                                           ...
                                                                                           <td><?php echo $form->textField($combustible,"[$i]hCarguio",array('id'=>"kmCarguio$i",'class'=>'fixed','disabled'=>'disabled',));?></td>
