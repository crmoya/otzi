...
<script language="javascript" type="text/javascript">
	$(function() {
		...
		$(document.body).on('keyup','.rut_proveedor',function(e){
			  ...
			  data: { admin1:  $('#RCamionArrendado_administrador_1').val(), admin2:$('#RCamionArrendado_administrador_2').val(), aut1: $('#RCamionArrendado_clave_admin_1').val(), aut2: $('#RCamionArrendado_clave_admin_2').val(),report_id:<?php echo $model->id;?>}
			}).done(function( msg ) {
                            if(msg != 'OK'){
                                alert(msg);
                            }
