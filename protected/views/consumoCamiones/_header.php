 ...
 <tr>
  <td>
	...
	<td>
	    ...
	    <?php echo $form->dropDownList($model,'agruparPor', CHtml::listData(array(array('id'=>'NINGUNO','nombre'=>'Sin agrupación'),array('id'=>'MAQUINA','nombre'=>'Vehículo'),array('id'=>'OPERADOR','nombre'=>'Chofer')), 'id', 'nombre')); ?>
	</td>
	<td>
